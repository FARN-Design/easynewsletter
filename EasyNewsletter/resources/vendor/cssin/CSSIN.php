...
namespace resources\vendor\cssin;
...
class CSSIN
{
	...
	*/
	function inlineCSS($url, $contents=null)
	{
		...
		if($contents === null)
		{
			$html = file_get_html($url, false, null, 0, -1, true, true, DEFAULT_TARGET_CHARSET, false, DEFAULT_BR_TEXT, DEFAULT_SPAN_TEXT);
		}
