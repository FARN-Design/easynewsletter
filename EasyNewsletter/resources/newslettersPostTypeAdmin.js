jQuery(document).ready(function ($){
    ...
    setTimeout(function (){
        const element = $(".edit-post-header__toolbar")
        // sendNewsletter-button
        element.append("<button class='components-button editor-post-switch-to-draft is-tertiary en_wantToSendNewsletter'>Send Newsletter Now</button>");
        // testMail-button
        element.append("<button class='components-button editor-post-switch-to-draft is-tertiary en_TestmailButton'>Send Test Mail</button>");
        // newsletterPopup
    ...
    $(document).on('click','.en_wantToSendNewsletter', function() {
        ...
        const post_id_val = $("#metaboxes #post_ID").val();
        const ajax_data = {
